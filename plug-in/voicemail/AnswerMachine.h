...
class AnswerMachineFactory: public AmStateFactory
{
    SemsConfiguration m_config;
...
class AnswerMachineDialog : public AmDialogState
{
 ...
 public:
    AnswerMachineDialog(string announce_file, const EmailTemplate* tmpl);
    ~AnswerMachineDialog();
