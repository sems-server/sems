...
bool UriParser::isEqual(const UriParser& c) const {
 ...
 *
 */
bool UriParser::parse_params(string& line, int& pos) {
...
bool UriParser::parse_contact(string& line, size_t pos, size_t& end) {
